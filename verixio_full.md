# AGENT N9ER — FULL MONOREPO (COMPRESSED, ONE FILE)
...
## WATCHERS
async def watch_gmail(c,a,t):return[{"type":"new_unread_email"}]
...
async def watch_asana(c,a,t):return[{"type":"new_task"}]
async def watch_trello(c,a,t):return[{"type":"new_card"}]
async def watch_github(c,a,t):return[{"type":"new_issue"}]
